 ...
 <div className="messages-container">
  {(messages || []).map((msg, idx) => (
    <div key={idx} className={`message ${msg.role}`}>
      ...
      <div className="message-header">
        ...
        {msg.ragMode && (
          <span className="rag-tag">
            {msg.ragMode === 'compare_rerank' ? '⚖️ Compare' :
             msg.ragMode === 'reranked_rag' ? '🔥 Reranked' :
             msg.ragMode === 'basic_rag' ? '📚 Basic RAG' : msg.ragMode}
          </span>
        )}
      </div>
      ...
      {/* ✅ ИСТОЧНИКИ RAG (только для assistant с sources) */}
            ...
            {msg.sources.map((source, i) => (
              <div key={i} className="source-item" title={source.preview}>
                ...
                <span className="source-score">
                  {source.rerankScore ? `${source.rerankScore}r` : source.score}
                </span>
